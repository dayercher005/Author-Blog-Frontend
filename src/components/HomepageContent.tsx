         ...
         <div className="">
            <RiseUp>
                <div className="flex justify-evenly py-20">
                    ...
                    <img className="size-85" src="/src/assets/writing.svg"></img>
                </div>
            </RiseUp>
            ...
            <RiseUp>
                <div id="Authenticate" className="flex justify-evenly py-20">
                    <img className="size-85" src="/src/assets/components.svg"></img>
                    <div className="max-w-lg">
            ...
            <FadeIn>
                <div id="Global" className="flex justify-evenly pt-15 pb-20">
                    ...
                    <img className="size-85" src="/src/assets/blog.svg"></img>
                </div>
            </FadeIn>
        </div>
    )
